...
public class Admin_link {
    ...
    public Admin_link(Long id,Integer parent_admin_id,Integer area_id,Integer admin_id,Integer status,Integer create_at,Integer update_at,Integer delete_at) {
        this.id=id;
