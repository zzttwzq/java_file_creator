...
public class Dev_msg {
    ...
    public Dev_msg(Long id,Integer dev_id,Integer last_time,Integer status,String snno,String ccid,String rfid,String proportion,Float temperature,Integer humidity,Float nh3,Integer dayon,Integer dayoff,Integer nighton,Integer nightoff,Integer addwaternum,Integer addwatertime,Integer atomizerpwm,Integer fanmin,Integer fanmax,Float totaladdwater,String hrev,String srev,Integer create_at,Integer update_at,Integer delete_at) {
        this.id=id;
        this.dev_id=dev_id;
